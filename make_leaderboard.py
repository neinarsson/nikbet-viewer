...
<style>
  ...
  * {{ box-sizing:border-box; }}
  ...
  .track span:last-child {{ border-right-color:transparent; }}
...
async function makeBlob() {{
  ...
  // backgroundColor: null → transparenta hörn. (Vissa appar/editorer visar
  // transparent som vitt, men själva filen är transparent.)
